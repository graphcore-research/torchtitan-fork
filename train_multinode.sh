...
torchrun --nnodes 2 --nproc_per_node 8 --rdzv_id 101 --rdzv_backend c10d --rdzv_endpoint "$head_node_ip:29500" ${TORCHRUN_EXTRA_ARGS} ./train.py --job.config_file ${CONFIG_FILE} $@
